...
insert into pedido(entidade, cnpj, nomecri, medA, medB, medC, medD, medE, medF, obs)
values(?,?,?,?,?,?,?,?,?,?);
 
<sql:param value="${param['edtEntidade']}"/> 
<sql:param value="${param['edtCNPJ']}"/>
<sql:param value="${param['edtNomeCri']}"/> 
<sql:param value="${param['edtMedA']}"/> 
<sql:param value="${param['edtMedB']}"/>
<sql:param value="${param['edtMedC']}"/>
<sql:param value="${param['edtMedD']}"/>  
<sql:param value="${param['edtMedE']}"/>  
<sql:param value="${param['edtMedF']}"/>  
